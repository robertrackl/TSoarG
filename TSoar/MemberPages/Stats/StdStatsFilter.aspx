<%@ Page Title="StdStatsFilter" Language="C#" MasterPageFile="~/mTSoar.Master" AutoEventWireup="true"
    CodeBehind="StdStatsFilter.aspx.cs" Inherits="TSoar.MemberPages.Stats.StdStatsFilter" %>

<asp:Content ID="HeaderContent" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="server">
    <asp:Label runat="server" Text="Set Flight Operations Statistics Standard Filter Properties for the Current User" Font-Italic="true" />
</asp:Content>
...
<%--        In the SelectCommand below, "UNION ALL SELECT ' ','0'" puts a blank item into the first position of the dropdown list--%>
    ...
    <div>
        ...
        <asp:Label runat="server"
            ...
            <li>Pay attention to the tool tips: floating text that appears when you hover the mouse cursor over many of the elements below.</li>
            <li>Tow plane flights are separate from glider flights; to not show tow plane flights set the equipment role filter to 'Glider' with the 'Use' checkbox checked.</li>
            </ul>
        </div>
        <asp:Table runat="server" ID="tblIN" BorderStyle="Solid" GridLines="Both" HorizontalAlign="Center" CssClass="SoarNPGridStyle" >
            <asp:TableHeaderRow>
                ...
                <asp:TableHeaderCell runat="server" Text="" Visible="false" />
                <asp:TableHeaderCell runat="server" Text="" Visible="false" />
                <asp:TableHeaderCell runat="server" CssClass="text-center"  >
                    <asp:Label Text="Selected Item" runat="server" BackColor="White" Width="280" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1" Visible="false" />
                    <asp:Label Text="Selector" runat="server" BackColor="White" Width="280" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1" ToolTip="Click on a filter's drop down list, then select an item" />
                </asp:TableHeaderCell>
            ...
            <asp:TableRow>
                ...
                </asp:TableCell><asp:TableCell HorizontalAlign="Center" Visible="false">
                    <asp:CheckBox runat="server" ID="chbAviatorIN" Checked="true" Enabled="false" OnCheckedChanged="chb_CheckedChanged" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center" Visible="false">
                    <asp:Button ID="pbResetAv" runat="server" Text="" Height="15" CssClass="roundedbutton" Enabled="false" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center">
                    <asp:TextBox ID="txbDDLAviator" runat="server" ReadOnly="true" Font-Size="X-Small" Text="All" CssClass="box_width" Visible="false" />
                    <asp:DropDownList ID="DDLAviator" runat="server" Width="300" DataSourceID="SqlDataSrc_Aviators" AutoPostBack="true"
                        DataTextField="sDisplayName" DataValueField="ID" OnDataBound="DDL_DataBound" OnSelectedIndexChanged="DDL_SelectedIndexChanged" ToolTip="Select from this drop down an item on which to filter" />
                </asp:TableCell>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Center">
                    ...
                    <asp:CheckBox runat="server" ID="chbAvRoleIN" Checked="true" Enabled="false" OnCheckedChanged="chb_CheckedChanged" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center" Visible="false">
                    <asp:Button ID="pbResetAvRole" runat="server" Text="" Height="15" CssClass="roundedbutton" Enabled="false" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center">
                    <asp:TextBox ID="txbDDLAvRole" runat="server" ReadOnly="true" Font-Size="X-Small" Text="All" CssClass="box_width" Visible="false" />
                    <asp:DropDownList ID="DDLAvRole" runat="server" Width="300" DataSourceID="SqlDataSrc_AvRole" AutoPostBack="true"
                        DataTextField="sAviatorRole" DataValueField="ID" OnDataBound="DDL_DataBound" OnSelectedIndexChanged="DDL_SelectedIndexChanged" ToolTip="Select from this drop down an item on which to filter" />
            ...
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Center">
                    ...
                    <asp:CheckBox runat="server" ID="chbTOLocationIN" Checked="true" Enabled="false" OnCheckedChanged="chb_CheckedChanged" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center" Visible="false">
                    <asp:Button ID="pbResetTOLocation" runat="server" Text="" Height="15" CssClass="roundedbutton" Enabled="false" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center">
                    <asp:TextBox ID="txbDDLTOLocation" runat="server" ReadOnly="true" Font-Size="X-Small" Text="All" CssClass="box_width" Visible="false" />
                    <asp:DropDownList ID="DDLTOLocation" runat="server" Width="300" DataSourceID="SqlDataSrc_Location" AutoPostBack="true"
                        DataTextField="sLocation" DataValueField="ID" OnDataBound="DDL_DataBound" OnSelectedIndexChanged="DDL_SelectedIndexChanged" ToolTip="Select from this drop down an item on which to filter" />
                </asp:TableCell></asp:TableRow>
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Center">
                    ...
                    <asp:CheckBox runat="server" ID="chbLDLocationIN" Checked="true" Enabled="false" OnCheckedChanged="chb_CheckedChanged" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center" Visible="false">
                    <asp:Button ID="pbResetLDLocation" runat="server" Text="" Height="15" CssClass="roundedbutton" Enabled="false" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center">
                    <asp:TextBox ID="txbDDLLDLocation" runat="server" ReadOnly="true" Font-Size="X-Small" Text="All" CssClass="box_width" Visible="false" />
            ...
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Center">
                    ...
                    <asp:CheckBox runat="server" ID="chbChargeCodeIN" Checked="true" Enabled="false" OnCheckedChanged="chb_CheckedChanged" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center" Visible="false">
                    <asp:Button ID="pbResetChargeCode" runat="server" Text="" Height="15" CssClass="roundedbutton" Enabled="false"/>
                </asp:TableCell><asp:TableCell HorizontalAlign="Center">
                    <asp:TextBox ID="txbDDLChargeCode" runat="server" ReadOnly="true" Font-Size="X-Small" Text="All" CssClass="box_width" Visible="false" />
                    <asp:DropDownList ID="DDLChargeCode" runat="server" Width="300" DataSourceID="SqlDataSrc_ChargeCode" AutoPostBack="true"
                        DataTextField="sChargeCode" DataValueField="ID" OnDataBound="DDL_DataBound" OnSelectedIndexChanged="DDL_SelectedIndexChanged" ToolTip="Select from this drop down an item on which to filter" />
                </asp:TableCell></asp:TableRow>
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Center">
                    ...
                    <asp:CheckBox runat="server" ID="chbLaunchMethodIN" Checked="true" Enabled="false" OnCheckedChanged="chb_CheckedChanged" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center" Visible="false">
                    <asp:Button ID="pbResetLaunchMethod" runat="server" Text="" Height="15" CssClass="roundedbutton" Enabled="false" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center">
                    <asp:TextBox ID="txbDDLLaunchMethod" runat="server" ReadOnly="true" Font-Size="X-Small" Text="All" CssClass="box_width" Visible="false" />
                    <asp:DropDownList ID="DDLLaunchMethod" runat="server" Width="300" DataSourceID="SqlDataSrc_LaunchMethod" AutoPostBack="true"
                        DataTextField="sLaunchMethod" DataValueField="ID" OnDataBound="DDL_DataBound" OnSelectedIndexChanged="DDL_SelectedIndexChanged" ToolTip="Select from this drop down an item on which to filter" />
                </asp:TableCell></asp:TableRow>
            <asp:TableRow>
                <asp:TableCell Text="Special Operations" />
                <asp:TableCell HorizontalAlign="Center">
                    ...
                    <asp:CheckBox runat="server" ID="chbSpecialOpsIN" Checked="true" Enabled="false" OnCheckedChanged="chb_CheckedChanged" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center" Visible="false">
                    <asp:Button ID="pgResetSpecialOps" runat="server" Text="" Height="15" CssClass="roundedbutton" Enabled="false" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center">
                    <asp:TextBox ID="txbDDLSpecialOps" runat="server" ReadOnly="true" Font-Size="X-Small" Text="All" CssClass="box_width" Visible="false" />
                    <asp:DropDownList ID="DDLSpecialOps" runat="server" Width="300" DataSourceID="SqlDataSrc_SpecialOpTypes" AutoPostBack="true"
                        DataTextField="sSpecialOpType" DataValueField="ID" OnDataBound="DDL_DataBound" OnSelectedIndexChanged="DDL_SelectedIndexChanged" ToolTip="Select from this drop down an item on which to filter" />
                </asp:TableCell></asp:TableRow>
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Center">
                    ...
                    <asp:CheckBox runat="server" ID="chbEquipmentIN" Checked="true" Enabled="false" OnCheckedChanged="chb_CheckedChanged" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center" Visible="false">
                    <asp:Button ID="pbResetEquipment" runat="server" Text="" Height="15" CssClass="roundedbutton" Enabled="false" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center">
                    <asp:TextBox ID="txbDDLEquipment" runat="server" ReadOnly="true" Font-Size="X-Small" Text="All" CssClass="box_width" Visible="false" />
                    <asp:DropDownList ID="DDLEquipment" runat="server" Width="300" DataSourceID="SqlDataSrc_Equip" AutoPostBack="true"
                        DataTextField="sShortEquipName" DataValueField="ID" OnDataBound="DDL_DataBound" OnSelectedIndexChanged="DDL_SelectedIndexChanged" ToolTip="Select from this drop down an item on which to filter" />
                </asp:TableCell></asp:TableRow>
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Center">
                    ...
                    <asp:CheckBox runat="server" ID="chbEquipmentRoleIN" Checked="true" Enabled="false" OnCheckedChanged="chb_CheckedChanged" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center" Visible="false">
                    <asp:Button ID="pbResetEquipmentRole" runat="server" Text="" Height="15" CssClass="roundedbutton" Enabled="false" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center">
                    <asp:TextBox ID="txbDDLEquipmentRole" runat="server" ReadOnly="true" Font-Size="X-Small" Text="All" CssClass="box_width" Visible="false" />
                    <asp:DropDownList ID="DDLEquipmentRole" runat="server" Width="300" DataSourceID="SqlDataSrc_EquipmentRole" AutoPostBack="true"
                        DataTextField="sEquipmentRole" DataValueField="ID" OnDataBound="DDL_DataBound" OnSelectedIndexChanged="DDL_SelectedIndexChanged" ToolTip="Select from this drop down an item on which to filter" />
                </asp:TableCell></asp:TableRow>
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Center">
                    ...
                    <asp:CheckBox runat="server" ID="chbEquipmentTypeIN" Checked="true" Enabled="false" OnCheckedChanged="chb_CheckedChanged" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center" Visible="false">
                    <asp:Button ID="pbResetEquipmentType" runat="server" Text="" Height="15" CssClass="roundedbutton" Enabled="false" />
                </asp:TableCell><asp:TableCell HorizontalAlign="Center">
                    <asp:TextBox ID="txbDDLEquipmentType" runat="server" ReadOnly="true" Font-Size="X-Small" Text="All" CssClass="box_width" Visible="false" />
                    <asp:DropDownList ID="DDLEquipmentType" runat="server" Width="300" DataSourceID="SqlDataSrc_EquimentType" AutoPostBack="true"
                        DataTextField="sEquipmentType" DataValueField="ID" OnDataBound="DDL_DataBound" OnSelectedIndexChanged="DDL_SelectedIndexChanged" ToolTip="Select from this drop down an item on which to filter" />
                </asp:TableCell></asp:TableRow></asp:Table><div style="text-align:center">
        <p><span style='color:red; font-weight:bold'>
                    (1)</span>: Put checkmarks in this column to 'Use' a filter, uncheck to ignore</p>
