<%@ Page Title="TSoar OpsScheduleSignup" Language="C#" MasterPageFile="~/mTSoar.Master" AutoEventWireup="true"
    CodeBehind="OpsScheduleSignup.aspx.cs" Inherits="TSoar.MemberPages.OpsScheduleSignup.OpsScheduleSignup" %>

<asp:Content ID="ContentHeader" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="server">
    <asp:Label runat="server" Text="Schedule of Operations and Events - Member Signup" Font-Italic="true" />
</asp:Content>

<asp:Content ID="ContentMain" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <div class="HelpText" ><%-- SCR 213 --%>
        <div id="divHRef" runat="server"></div>
        Dear User: you have been recognized as "<asp:Label ID="lblUserDisplayName" runat="server" Text="?" Font-Bold="true" />"
    </div><%-- SCR 213 --%>
                    ...
                    <ol>
                        ...
                        <li>
                            <p>The blue squares in table cells are clickable <b>buttons</b>. When you click one a window pops up:
                                <ul>
                                    <li>If the cell you clicked does not yet have any data in it, then you can <u>add</u> a new signup; but also see point 3 below.</li>
