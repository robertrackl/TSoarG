...
namespace TSoar
{
    public class CustomerCRUD
    {
        ...
        public void CustomerFindbyIdTestUsingoAuth(ServiceContext qboContextoAuth)
        {
            ...
            customer.Id = "92";
            //Adding the Customer
            //r4// Customer added = Helper.Add<Customer>(qboContextoAuth, customer);
            //r4// Customer found = Helper.FindById<Customer>(qboContextoAuth, added);
            Customer found = Helper.FindById<Customer>(qboContextoAuth, customer);
        }
